...
недосошлись, точку метим невалидной. Это делает вулкан строгим: цена ошибки
в одном шаге видна как разъезд с C.

Ограничения: M₄-КЛАСТЕР, не решётка — числа суть ЭНЕРГЕТИКА МОТИВА (N на грани из 4
...
METALS = {
    ...
    # --- расширение вулкана (Этап 22): группа I (HER-голодание вниз по столбцу?),
    #     группа II (мягкость вниз?), Al, и TM-нитриды (реальные CLAS-медиаторы) ---
    "Na": {"a_mm": 3.7, "a_mn": 2.4, "spins_m4": [0, 2], "spins_m4n": [1, 3]},
    "K":  {"a_mm": 4.6, "a_mn": 2.8, "spins_m4": [0, 2], "spins_m4n": [1, 3]},
    "Sr": {"a_mm": 4.3, "a_mn": 2.6, "spins_m4": [0, 2], "spins_m4n": [1, 3]},
    "Ba": {"a_mm": 4.3, "a_mn": 2.8, "spins_m4": [0, 2], "spins_m4n": [1, 3]},
    "Al": {"a_mm": 2.8, "a_mn": 1.9, "spins_m4": [0, 2], "spins_m4n": [1, 3]},
    "V":  {"a_mm": 2.4, "a_mn": 1.8, "spins_m4": [0, 4, 8, 12],
           "spins_m4n": [1, 5, 9, 13]},
    "Cr": {"a_mm": 2.5, "a_mn": 1.8, "spins_m4": [0, 4, 8, 12, 16],
           "spins_m4n": [1, 5, 9, 13, 17]},
    "Mo": {"a_mm": 2.7, "a_mn": 2.0, "spins_m4": [0, 2, 4, 6, 8],
           "spins_m4n": [1, 3, 5, 7, 9]},
}
