...
Модель v1 (честно минимальная): [Fe(SH)₃(N₂)]⁻ — Fe(II) d6 на трёх тиолах
...
ЧЕСТНО: каркас заморожен и идеализирован (не оптимум!) — сдвиги ПО ПОЛЮ при
фиксированном каркасе честны как чувствительность, абсолютный R_min — нет;
