...
def _ligand_atoms():
    """Минимальный PNP (H2P-NH-PH2) на открытой (−z) грани Cr. Грубый старт —
    релакс доводит; два P координируют Cr (κ²), N мостиком."""
    if LIGAND != "pnp":
        return []
    return [("P", (1.35, 0.0, -2.05)), ("P", (-1.35, 0.0, -2.05)),
            ("N", (0.0, 0.0, -3.05)), ("H", (0.0, 0.90, -3.55)),
            ("H", (2.25, 0.55, -2.5)), ("H", (1.55, -1.05, -2.8)),
            ("H", (-2.25, 0.55, -2.5)), ("H", (-1.55, -1.05, -2.8))]
