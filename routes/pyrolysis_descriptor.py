...
Минимальная обоснованная модель (стенд-ин, НЕ периодический расплав — как и всюду
...
допустимых по чётности мультиплетностей (строго говоря, как в соседних треках).
...
def valid_spins(atoms, charge=0, n=None):
    ...
    конкуренция биметалл-димера; берём нижнюю по энергии (объективная оговорка)."""
    base = None
    for s in (0, 1):
        try:
...
# геометрии (объективная оговорка: неполный релакс, скрин-оценка).
